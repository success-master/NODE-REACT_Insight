...
import {
    AM_period_chart_1, AM_account_chart, AM_account_manager_chart,
  ...
  return  (
      <div className="barChartContainer" ref={containerRef} style={{ alignItems: 'flex-start' }}>
          <div className="barChart__header">
              <h3 style={{ fontSize: "1.8rem" }}>Active Accounts</h3>
              <div className="barChart__legend" >
                  ...
                  >
                      ...
                      <List component="nav" className="context-menu" aria-label="secondary mailbox folders">
                          ...
                          <ExportToJPG elementToConvert={containerRef} imageName="Active Accounts" handleClose={handleClose} />
                          <MenuItem onClick={handleClose}>
